/* Updated by Sunakshi
Line numbers = 198 to 203 and 95,96*/
/* Controllers */
...
.controller('MainController',
    ...
    $scope.$watch('selectedOrgUnit', function() {
        ...
        $scope.programUID = url.substr(13);
    ...
    $scope.loadPrograms = function() {
        ...
        if (angular.isObject($scope.selectedOrgUnit)) {
            ...
            ProgramFactory.getProgramsByOu($scope.selectedOrgUnit, $scope.selectedProgram).then(function(response){
                ...
                $scope.getResponse = response.programs;

                for(var i =0;i<$scope.getResponse.length;i++)
                {
                    if($scope.getResponse[i].id == $scope.programUID)
                    {
                        response.selectedProgram = $scope.getResponse[i];
